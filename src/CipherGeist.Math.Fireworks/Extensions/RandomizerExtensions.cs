...
public static class RandomizerExtensions
{
	...
	public static double NextDouble(this IRandomizer random, double minInclusive, double maxExclusive)
	{
	...
	/// <returns>A random double in the required range.</returns>
	public static double NextDouble(this IRandomizer random, Interval allowedRange)
	{
		double correctValue;
	...
	public static IEnumerable<int> NextInt32s(this IRandomizer random, int neededValuesNumber, int minInclusive, int maxExclusive)
	{
		...
		MathNet.Numerics.Random.RandomExtensions.NextInt32s((System.Random)random, result, minInclusive, maxExclusive);
	...
	public static IEnumerable<int> NextUniqueInt32s(this IRandomizer random, int neededValuesNumber, int minInclusive, int maxExclusive)
	{
		ArgumentNullException.ThrowIfNull(random);
		ArgumentOutOfRangeException.ThrowIfNegative(neededValuesNumber);
	...
	public static bool NextBoolean(this IRandomizer random)
	{
		ArgumentNullException.ThrowIfNull(random);
		return MathNet.Numerics.Random.RandomExtensions.NextBoolean((System.Random)random);
	}

	private static double NextDoubleInternal(IRandomizer random, double minInclusive, double intervalLength)
	{
		ArgumentNullException.ThrowIfNull(random);
